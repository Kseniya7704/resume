...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'Київ, проспект Перемоги, 54/1',
}
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'Інститут банківських технологій та бізнесу',
          isEnd: true,
        },
        {
          name: 'Інститут міжнародних відносин Київського національного університету імені Тараса Шевченка',
          isEnd: true,
        },
        {
          name: 'Київська академія міжнародної економіки і міжнародних відносин (КАМЕМВ)',
          isEnd: false,
        },
        {
          name: 'Київський інститут бізнесу та технологій (КІБІТ)',
          isEnd: false,
        },
      ],
      ...
      certificates: [
        ...
        {
          name: 'JavaScript Certification (CJSD)',
          id: '76397542877',
        },
      ],
    },
          ...
          project: [
            {
              ...
              awards: [
                {
                  name: 'Proposed an idea that made the site more user-friendly',
                },
                {
                  name: 'Improved the structure of the company website',
                },
              ],
              stackAmount: 7,
              awardAmount: 5,
